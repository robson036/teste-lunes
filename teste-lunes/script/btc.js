...
function cotacaoBtc(){
	...
	$("body")
		...
		document.getElementById("cotacaoBtc").innerHTML = response.data.prices[3].price
	}, "json");
}

//A partir daqui carrega tabela com infos de endereço de bitecoin
function infosBtc(){	
	...
	function criarTabela(conteudo) {
  	...
  	return tabela;
			...
			$.get("https://chain.so/api/v2/get_tx_received/BTC/" + endereco, function(response){
				$("body")
